...
export const config = {
   ...
   */
  matcher: [
    "/((?!api|_next/static|_next/image|fonts|favicon.ico|icon.svg|robots.txt|manifest.webmanifest|sw.js|offline.html|icons/|splash/|categories/|apple-icon.png|dcc-safer-use-brochure.pdf).*)",
  ],
};
